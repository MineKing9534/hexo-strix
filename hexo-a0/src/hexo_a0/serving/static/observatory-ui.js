  ...
  <div id="proof-explorer" role="dialog" aria-modal="true" aria-labelledby="proof-explorer-title" hidden>
    <header class="proof-explorer-header">
      ...
      <div class="proof-explorer-actions">
        ...
        <button id="proof-worst-btn" class="proof-primary" @click=${()=>n("proofExplorerWorstCase")} title="Follow the reply that delays the win longest">Show longest defence &rarr;</button>
        <button id="proof-alternatives-btn" @click=${()=>n("proofExplorerFindAlternatives")} title="Find another position with more than one winning move">Other winning moves</button>
        <button @click=${()=>n("proofFitBoard")} title="Fit the current proof position on screen">Fit board</button>
        <button id="proof-share-btn" @click=${()=>n("shareForcingCertificate")} title="Save this result and copy its link">Copy link</button>
        <button @click=${()=>n("downloadForcingCertificate")}>Download result</button>
        <button id="proof-close-btn" class="proof-close" @click=${()=>n("closeProofExplorer")} aria-label="Close proof explorer">Close</button>
      </div>
    </header>
