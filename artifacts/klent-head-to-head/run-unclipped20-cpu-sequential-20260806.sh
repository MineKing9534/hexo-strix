...
run_match() {
    ...
    local opponent="$2"
    local seed="$3"
    local state_file="${artifact_dir}/cpu-unclipped20-vs-${slug}-20260806.json"
    local log_file="${artifact_dir}/cpu-unclipped20-vs-${slug}-20260806.log"
...
echo "[complete] all unclipped generation-20 CPU matches finished"
